...
KEEP = [
    ...
    ('/* =================================================================\n   SCROLL ANIMATIONS',
     '/* =================================================================\n   ICON METRICS'),
    # The homepage block was appended to style.css after this one, and it is
    # not module-page CSS: without this bound the slice runs to end of file and
    # drags all 2,700 lines of it in, prefixed .bbm-hp-*.
    ('/* =================================================================\n   MODULE PAGE',
     '/* ============ HOMEPAGE — generated by tools/assemble-home.py ============ */'),
]
