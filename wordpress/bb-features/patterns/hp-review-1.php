<?php
/**
 * Title: Home — Video review 1
 * Slug: bb-features/hp-review-1
 * Categories: bb-home
	...
	<div class="wp-block-group bbh-shell">
		...
		<div class="wp-block-group bbh-review__row">
			...
			<div class="wp-block-group bbh-review__media">
				<!-- wp:html -->
				<img class="bbh-review__portrait" src="<?php echo esc_url( get_theme_file_uri( 'assets/icon/av-review.png' ) ); ?>" alt="" />
				<!-- /wp:html -->
				<!-- wp:html -->
