			...
			<div class="wp-block-group bbf-halves__copy bbf-reveal bbf-reveal--right">
				...
				<div class="wp-block-group bbf-halves__intro">
					...
					<div class="wp-block-group bbf-halves__intro-head">
						...
						<!-- wp:heading {"className":"bbf-h3"} --><h2 class="wp-block-heading bbf-h3">Store media files on external storage</h2><!-- /wp:heading -->
					</div>
					<!-- /wp:group -->
					<!-- wp:paragraph {"className":"bbf-body"} --><p class="bbf-body">Reduce server storage and improve performance by offloading media files to cloud storage, ensuring faster loading times and a more scalable community.</p><!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
