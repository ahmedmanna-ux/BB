<?php
/**
 * Title: Home — Video review 3
 * Slug: bb-features/hp-review-3
 * Categories: bb-home
 * Description: Full-width customer quote: video portrait with a play badge, the quote mark, the quote and the reviewer credit.
 *
 * @package BB_Features
 */
...
?>
<!-- wp:group {"align":"full","className":"bbh bbh-review","layout":{"type":"default"}} -->
<div class="wp-block-group alignfull bbh bbh-review">
	...
	<div class="wp-block-group bbh-shell">
		...
		<div class="wp-block-group bbh-review__row">
			...
			<div class="wp-block-group bbh-review__media">
				...
				<figure class="wp-block-image size-full bbh-review__portrait"><img src="<?php echo esc_url( $bbh_img . 'hp-review-3.png' ); ?>" alt=""/></figure>
				<!-- /wp:image -->
				<!-- wp:html -->
