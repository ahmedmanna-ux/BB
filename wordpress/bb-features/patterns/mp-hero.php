<?php
/**
 * Title: Module — Member Profiles hero
 * Slug: bb-features/mp-hero
 * Categories: bb-module-pages
 * Description: Peach hero with the headline, two CTAs, profile artwork and the two background shapes.
 *
 * @package BB_Features
 */
	...
	<div class="wp-block-group bbm-shell bbm-hero__inner">
		...
		<div class="wp-block-group bbm-hero__copy bbm-reveal bbm-reveal--left">
			...
			<div class="wp-block-group bbm-hero__head">
				<!-- wp:html -->
				<span class="bbm-tag"><span>Member Profiles</span></span>
				<!-- /wp:html -->
				<!-- wp:heading {"level":1,"className":"bbm-h2"} -->
				<h1 class="wp-block-heading bbm-h2">Where usernames become a community</h1>
				<!-- /wp:heading -->
				<!-- wp:paragraph {"className":"bbm-body-sm"} -->
				<p class="bbm-body-sm">Rich profiles, a searchable member directory, and meaningful connections turn a simple user list into a thriving community—fully configurable to match your platform.</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		...
		<div class="wp-block-group bbm-hero__art bbm-reveal bbm-reveal--right">
			...
			<figure class="wp-block-image size-full"><img src="<?php echo esc_url( $bbm_img . 'mp-hero.png' ); ?>" alt="A BuddyBoss member profile with its header, timeline and profile fields, and a video tutorial play button"/></figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:group -->
	</div>
