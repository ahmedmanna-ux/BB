 ...
 * Description: Peach band with a three-column masonry of customer reviews.
 *
 * @package BB_Features
 */
	...
	<div class="wp-block-group bbm-shell">
		...
		<div class="wp-block-group bbm-rgrid bbm-stagger">
			...
			<div class="wp-block-group bbm-review">
				<!-- wp:html -->
				<img class="bbm-review__src" src="<?php echo esc_url( get_theme_file_uri( 'assets/icon/badge-trustpilot.png' ) ); ?>" alt="" aria-hidden="true" />
				<!-- /wp:html -->
				<!-- wp:group {"className":"bbm-review__who","layout":{"type":"default"}} -->
				<div class="wp-block-group bbm-review__who">
					<!-- wp:html -->
					<img src="<?php echo esc_url( get_theme_file_uri( 'assets/icon/av-dwayne.png' ) ); ?>" alt="" aria-hidden="true" />
					<!-- /wp:html -->
					<!-- wp:html -->
				...
				<div class="wp-block-group bbm-review__stars">
					<!-- wp:html -->
					<img src="<?php echo esc_url( get_theme_file_uri( 'assets/icon/star-20.svg' ) ); ?>" alt="" aria-hidden="true" />
					<!-- /wp:html -->
					<!-- wp:html -->
					<img src="<?php echo esc_url( get_theme_file_uri( 'assets/icon/star-20.svg' ) ); ?>" alt="" aria-hidden="true" />
					<!-- /wp:html -->
			...
			<div class="wp-block-group bbm-review">
				...
				<div class="wp-block-group bbm-review__who">
					<!-- wp:html -->
					<img src="<?php echo esc_url( get_theme_file_uri( 'assets/icon/av-ryan.png' ) ); ?>" alt="" aria-hidden="true" />
					<!-- /wp:html -->
					<!-- wp:html -->
				...
				<div class="wp-block-group bbm-review__stars">
					...
					<!-- /wp:html -->
					<!-- wp:html -->
					<img src="<?php echo esc_url( get_theme_file_uri( 'assets/icon/star-20-outline.svg' ) ); ?>" alt="" aria-hidden="true" />
					<!-- /wp:html -->
				</div>
				<!-- /wp:group -->
				<!-- wp:paragraph {"className":"bbm-review__text"} -->
			...
			<div class="wp-block-group bbm-review">
				<!-- wp:html -->
				<img class="bbm-review__src" src="<?php echo esc_url( get_theme_file_uri( 'assets/icon/badge-capterra.svg' ) ); ?>" alt="" aria-hidden="true" />
				<!-- /wp:html -->
				<!-- wp:group {"className":"bbm-review__who","layout":{"type":"default"}} -->
				<div class="wp-block-group bbm-review__who">
					<!-- wp:html -->
					<img src="<?php echo esc_url( get_theme_file_uri( 'assets/icon/av-kyler.png' ) ); ?>" alt="" aria-hidden="true" />
					<!-- /wp:html -->
					<!-- wp:html -->
			...
			<div class="wp-block-group bbm-review">
				...
				<div class="wp-block-group bbm-review__who">
					<!-- wp:html -->
					<img src="<?php echo esc_url( get_theme_file_uri( 'assets/icon/av-review.png' ) ); ?>" alt="" aria-hidden="true" />
					<!-- /wp:html -->
					<!-- wp:html -->
