...
<div class="wp-block-group alignfull bbm bbm-shell bbm-section bbm-post">
	...
	<div class="wp-block-group bbm-minicards bbm-stagger">
		...
		<div class="wp-block-group bbm-minicard">
			<!-- wp:html -->
			<img src="<?php echo esc_url( get_theme_file_uri( 'assets/icon/feat-filetext.svg' ) ); ?>" alt="" aria-hidden="true" />
			<!-- /wp:html -->
		...
		<div class="wp-block-group bbm-minicard">
			<!-- wp:html -->
			<img src="<?php echo esc_url( get_theme_file_uri( 'assets/icon/mod-messaging.svg' ) ); ?>" alt="" aria-hidden="true" />
			<!-- /wp:html -->
			<!-- wp:heading {"level":3,"className":"bbm-minicard__title"} -->
