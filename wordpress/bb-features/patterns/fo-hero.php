<?php
/**
 * Title: Module — Forums hero
 * Slug: bb-features/fo-hero
 * Categories: bb-module-pages
 * Description: Peach hero with the headline, two CTAs, forum artwork and the two background shapes.
 *
 * @package BB_Features
 */
...
?>
<!-- wp:group {"align":"full","className":"bbm bbm-hero bbm-fo","layout":{"type":"default"}} -->
<div class="wp-block-group alignfull bbm bbm-hero bbm-fo">
	<!-- wp:html -->
	...
	<div class="wp-block-group bbm-shell bbm-hero__inner">
		...
		<div class="wp-block-group bbm-hero__copy bbm-reveal bbm-reveal--left">
			...
			<div class="wp-block-group bbm-hero__head">
				<!-- wp:html -->
				<span class="bbm-tag"><span>FORUMS</span></span>
				<!-- /wp:html -->
				<!-- wp:heading {"level":1,"className":"bbm-h2"} -->
				<h1 class="wp-block-heading bbm-h2">Discussions with a long shelf life</h1>
				<!-- /wp:heading -->
				<!-- wp:paragraph {"className":"bbm-body-sm"} -->
				<p class="bbm-body-sm">Structured boards for questions and answers that deserve better than a feed — threaded, tagged, searchable, and integrated into your social groups.</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		...
		<div class="wp-block-group bbm-hero__art bbm-hero__art--tight bbm-reveal bbm-reveal--right">
			...
			<figure class="wp-block-image size-full"><img src="<?php echo esc_url( $bbm_img . 'fo-hero.png' ); ?>" alt="A forum discussion thread with its opening post, tags and threaded replies"/></figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:group -->
	</div>
