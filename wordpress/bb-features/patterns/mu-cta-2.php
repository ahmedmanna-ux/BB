<?php
/**
 * Title: Module — CTA band
 * Slug: bb-features/mu-cta-2
 * Categories: bb-module-pages
 * Description: Dark full-width CTA band.
 *
 * @package BB_Features
 */
...
<div class="wp-block-group alignfull bbm bbm-shell bbm-section bbm-mu">
	<!-- wp:group {"className":"bbm-ctaband bbm-reveal","layout":{"type":"default"}} -->
	<div class="wp-block-group bbm-ctaband bbm-reveal">
